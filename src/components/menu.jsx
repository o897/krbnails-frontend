    ...
    <>
      ...
      <div className="menu">
        ...
        <div className="menu__container">
          <div className="menu__pricelist">
            ...
            <div className="menu__pricelist-row menu__bg-pink">
              <div className="menu__pricelist-row--title">Long</div>
              <div className="menu__pricelist-row--cost">R250</div>
            </div>
            <div className="menu__pricelist-row">
              <div className="menu__pricelist-row--title">XL</div>
              <div className="menu__pricelist-row--cost">R300</div>
            </div>
            <div className="menu__pricelist-row menu__bg-pink">
              <div className="menu__pricelist-row--title">CCL</div>
              <div className="menu__pricelist-row--cost">R350</div>
            </div>
            <div className="menu__pricelist-row  ">
              <div className="menu__pricelist-row--title">Acrylic Overlay</div>
        ...
        <div className="menu__container">
          <div className="menu__pricelist">
            <div className="menu__pricelist-row  menu__bg-pink">
              <div className="menu__pricelist-row--title">Pedicure</div>
              <div className="menu__pricelist-row--cost">R110</div>
            </div>
            <div className="menu__pricelist-row ">
              <div className="menu__pricelist-row--title">Gel Pedicure</div>
